...
class TestListWebhooks:
    """Tests for GET /web/api/v2.1/_dev/webhooks."""

    def test_requires_auth(self, client: TestClient) -> None:
        resp = client.get("/web/api/v2.1/_dev/webhooks")
        assert resp.status_code == 401

    def test_returns_empty_list_initially(
        self, client: TestClient, auth_headers: dict
    ) -> None:
        resp = client.get("/web/api/v2.1/_dev/webhooks", headers=auth_headers)
        assert resp.status_code == 200
        assert resp.json()["data"] == []


class TestCreateWebhook:
    """Tests for POST /web/api/v2.1/_dev/webhooks."""

    def test_creates_subscription(self, client: TestClient, auth_headers: dict) -> None:
        resp = client.post(
            "/web/api/v2.1/_dev/webhooks", headers=auth_headers, json=_VALID_PAYLOAD
        )
        assert resp.status_code == 200
        body = resp.json()["data"]
    ...
    def test_created_subscription_appears_in_list(
        ...
        client.post("/web/api/v2.1/_dev/webhooks", headers=auth_headers, json=_VALID_PAYLOAD)
        resp = client.get("/web/api/v2.1/_dev/webhooks", headers=auth_headers)
    ...
    def test_invalid_event_type_returns_400(
        ...
        resp = client.post("/web/api/v2.1/_dev/webhooks", headers=auth_headers, json=payload)
...
class TestGetWebhook:
    """Tests for GET /web/api/v2.1/_dev/webhooks/{id}."""
    ...
    def test_returns_subscription(self, client: TestClient, auth_headers: dict) -> None:
        ...
        resp = client.get(f"/web/api/v2.1/_dev/webhooks/{webhook_id}", headers=auth_headers)
        assert resp.status_code == 200
        assert resp.json()["data"]["id"] == webhook_id

    def test_unknown_id_returns_404(self, client: TestClient, auth_headers: dict) -> None:
        resp = client.get("/web/api/v2.1/_dev/webhooks/does-not-exist", headers=auth_headers)
        assert resp.status_code == 404


class TestDeleteWebhook:
    """Tests for DELETE /web/api/v2.1/_dev/webhooks/{id}."""
    ...
    def test_deletes_subscription(self, client: TestClient, auth_headers: dict) -> None:
        ...
        del_resp = client.delete(
            f"/web/api/v2.1/_dev/webhooks/{webhook_id}", headers=auth_headers
        )
