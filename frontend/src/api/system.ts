import type { SingleResponse, SystemStats, RequestLog, WebhookSubscription, RateLimitConfig, ProxyConfig, ProxyRecording } from '../types'
...
export const proxyApi = {
  ...
  setConfig: (cfg: { mode: string; base_url?: string; api_token?: string }): Promise<SingleResponse<ProxyConfig>> =>
