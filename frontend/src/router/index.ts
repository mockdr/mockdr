...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'graph',                              component: () => import('../views/graph/GraphDashboardView.vue') },
      { path: 'graph/users',                        component: () => import('../views/graph/GraphUsersView.vue') },
      { path: 'graph/groups',                       component: () => import('../views/graph/GraphGroupsView.vue') },
      { path: 'graph/conditional-access',            component: () => import('../views/graph/GraphConditionalAccessView.vue') },
      { path: 'graph/devices',                      component: () => import('../views/graph/GraphDevicesView.vue') },
      { path: 'graph/security/alerts',              component: () => import('../views/graph/GraphSecurityAlertsView.vue') },
      { path: 'graph/security/incidents',           component: () => import('../views/graph/GraphSecurityIncidentsView.vue') },
      { path: 'graph/teams',                        component: () => import('../views/graph/GraphTeamsView.vue') },
      { path: 'graph/plans',                        component: () => import('../views/graph/GraphPlanComparisonView.vue') },
      { path: 'graph/users/:id',                     component: () => import('../views/graph/GraphUserDetailView.vue') },
      { path: 'graph/devices/:id',                   component: () => import('../views/graph/GraphDeviceDetailView.vue') },
      { path: 'graph/groups/:id',                    component: () => import('../views/graph/GraphGroupDetailView.vue') },
      { path: 'graph/identity-protection',           component: () => import('../views/graph/GraphIdentityProtectionView.vue') },
      { path: 'graph/licenses',                      component: () => import('../views/graph/GraphLicensesView.vue') },
      { path: 'graph/sign-in-logs',                  component: () => import('../views/graph/GraphSignInLogsView.vue') },
      { path: 'graph/audit-logs',                    component: () => import('../views/graph/GraphAuditLogsView.vue') },
      { path: 'graph/compliance',                    component: () => import('../views/graph/GraphComplianceView.vue') },
      { path: 'graph/device-config',                 component: () => import('../views/graph/GraphDeviceConfigView.vue') },
      { path: 'graph/autopilot',                     component: () => import('../views/graph/GraphAutopilotView.vue') },
      { path: 'graph/apps',                          component: () => import('../views/graph/GraphAppsView.vue') },
      { path: 'graph/update-rings',                  component: () => import('../views/graph/GraphUpdateRingsView.vue') },
      { path: 'graph/mail',                          component: () => import('../views/graph/GraphMailView.vue') },
      { path: 'graph/files',                         component: () => import('../views/graph/GraphFilesView.vue') },
      { path: 'graph/security/attack-sim',           component: () => import('../views/graph/GraphAttackSimView.vue') },
    ],
  },
